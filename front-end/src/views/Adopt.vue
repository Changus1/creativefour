...
<div class='page'>
      ...
      <ProductList :products="products" v-on:favorite="favorite($event)" />
</div>
</template>
  ...
  computed: {
    ...
    products() {
      if (this.species === '' && this.gender === '' && this.age2 === '') {
       ...
       let filter = this.animals.filter(product => product.species === this.species && product.gender === this.gender);
       return filter.filter(element => element.age === this.age1 || element.age === this.age2 || element.age === this.age3);
      }
      else {
        if (this.species != '') {
          if (this.gender != '') {
            return this.animals.filter(product => product.species === this.species && product.gender === this.gender);
          }
          else if (this.age3 != '') {
            let filter = this.animals.filter(product => product.species === this.species);
            return filter.filter(element => element.age === this.age1 || element.age === this.age2 || element.age === this.age3);
          }
          else {
            return this.animals.filter(product => product.species === this.species);
          }
        }
        else if (this.gender != '') {
          if (this.age3 != '') {
            let filter = this.animals.filter(product => product.gender === this.gender);
            return filter.filter(element => element.age === this.age1 || element.age === this.age2 || element.age === this.age3);
          }
          else {
            return this.animals.filter(product => product.gender === this.gender);
          }
        }
        else {
          return this.animals.filter(element => element.age === this.age1 || element.age === this.age2 || element.age === this.age3);
        }
      }
    }
  },
